...
Citizen.CreateThread(
    function()
        ...
        while true do
            ...
            if (IsControlJustPressed(0, Config.openKey)) and GetLastInputMethod( 0 ) and Config.needItem and not Config.onlyJob then
			...
			if (IsControlJustPressed(0, Config.openKey)) and GetLastInputMethod( 0 ) and Config.needItem and Config.onlyJob then
					local inventory = ESX.GetPlayerData().inventory
					local count = 0
